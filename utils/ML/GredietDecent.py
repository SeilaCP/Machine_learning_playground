...
class GredietDecent():
    ...
    def compute_gradient(self, x, y, w, b): 
        ...
        Details Explanation:
            cost function ជាកម្លាតរវាង​ Y ដើមនៃDataរបស់យើង ​- Y ដែលយើងប៉ានស្មាន(predict) (just example with easy to understand)
            x ជាតម្លៃប៉ារ៉ាមែត​ និង​ Y ជាតម្លៃដែលយើងចង់ស្វែងរក 
            តាម​ Y = f(x) = wx + b
        """
